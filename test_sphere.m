...
%%
N = length(x);
Boundary=find(x==x_min | x==x_max | y==y_min | y==y_max| z==z_min | z==z_max);
%%
...
Cn = -tanh((0.22 - sqrt(x.^2 + y.^2 + z.^2))/(sqrt(2)));
